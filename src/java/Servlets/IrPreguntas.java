...
public class IrPreguntas extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        throws ServletException, IOException {
            ...
            PrintWriter out = response.getWriter(); 
                ...
                out.println("<div id=\"MainMenuPreguntas\"></div>");                
               
                out.println("<script type=\"text/babel\" src=\"components/MainMenuPreguntas.js\"></script>");
