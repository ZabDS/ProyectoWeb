...
import org.jdom.input.SAXBuilder;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        session.setAttribute("preguntasDisponibles", convertirAArregloJS(nombreDePreguntas.toArray(new String[0])));
        ...
        ArrayJS=convertirAArregloJS(nombreDePreguntas.toArray(new String[0]));    
            PrintWriter out = response.getWriter(); 
                ...
                out.println("<script type=\"text/babel\">var PreguntasD = "+ArrayJS+";</script>");
