...
public class IrExamen extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        throws ServletException, IOException {
            ...
            PrintWriter out = response.getWriter(); 
                ...
                out.println("<div id=\"MainMenuExamen\"></div>");                
               
                out.println("<script type=\"text/babel\" src=\"components/MainMenuExamen.js\"></script>");
