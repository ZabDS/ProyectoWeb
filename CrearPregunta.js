      ...
      <MuiThemeProvider theme={theme}>
        ...
        <List className={classes.List}>
         ...
         <CardContent>
          ...
          <Typography>
           <form className={classes.container} noValidate autoComplete="off" method="POST" action="GetPregunta">
             {/*
                <TextField
                id="QuestName"
                ...
                */}
                 <Typography gutterBottom variant="h6" component="h6">
                 Formula: <input name="Formula" value={FormText} /><br/>
                 </Typography>
                 <Typography gutterBottom variant="h6" component="h6">
                 Puntación: <input name="Puntuacion" value={Points}  />
                 </Typography>
