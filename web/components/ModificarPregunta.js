...
Button,
        ...
        var AnswerTol;
        var Points;
        var preguntasP = preguntasDisponibles;
            ...
            <Grid item xs={0}>
                ...
                <CardActionArea>
                    <CardContent>
                        ...
                        <Typography>
                            <form className={classes.container} noValidate autoComplete="off" method="POST" action="ModificarPregunta">
                                <label for="id_select"> Selecciona tu pregunta </label>
                                <select id="Nombre"
                                        name="Nombre">{
                        preguntasDisponibles.map(function (pregunta) {
